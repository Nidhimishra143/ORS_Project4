 ...
 */
@ WebServlet(name="StudentEditCtl",urlPatterns={"/ctl/StudentEditCtl.do"})

public class StudentEditCtl extends BaseCtl {
	private static Logger log = Logger.getLogger(StudentEditCtl.class);
	...
	protected void doPost(HttpServletRequest request,
		 ...
		 log.debug("StudentEditCtl Method doPost Started");
	...
	protected String getView() {
		return ORSView.STUDENTEDIT_VIEW;
	}
	...
	protected void doGet(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		 log.debug("StudentEditCtl Method doGet Started");
	        ...
	        ServletUtility.forward(getView(), request, response);
	        log.debug("StudentEditCtl Method doGett Ended");
	}
