...
/**
 * Servlet implementation class UserEditClt
 */
@ WebServlet(name="UserEditClt",urlPatterns={"/ctl/UserEditClt.do"})

public class UserEditClt extends BaseCtl {
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(UserEditClt.class);
	...
	protected boolean validate(HttpServletRequest request) {
		log.debug("UserEditCtl Method validate Started");
		boolean pass = true;
		...
		log.debug("UserEditCtl Method validate Ended");
		return pass;
	}

	@Override
	protected BaseBean populateBean(HttpServletRequest request) {
		log.debug("UserEditCtl Method populatebean Started");
		...
		log.debug("UserEditCtl Method populatebean Ended");
		return bean;
	}
