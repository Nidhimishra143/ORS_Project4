...
public class StudentModel {
	...
	public Integer nextPK() throws DatabaseException {
		...
		try {
			...
			PreparedStatement pstmt = conn
					.prepareStatement("SELECT MAX(ID) FROM demo_ors.student;");
	...
	public long add(StudentBean bean) throws ApplicationException,
		...
		try {
			...
			PreparedStatement pstmt = conn
					.prepareStatement("INSERT INTO demo_ors.student VALUES(?,?,?,?,?,?,?,?,?,?,?,?)");
			pstmt.setInt(1, pk);
	...
	public void delete(StudentBean bean) throws ApplicationException {
		...
		try {
			...
			conn.setAutoCommit(false); // Begin transaction
			PreparedStatement pstmt = conn
					.prepareStatement("DELETE FROM demo_ors.student WHERE ID=?");
	...
	public StudentBean findByEmailId(String Email) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer(
				"SELECT * FROM demo_ors.student WHERE EMAIL=?");
	...
	public StudentBean findByPK(long pk) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM demo_ors.student WHERE ID=?");
		StudentBean bean = null;
		Connection conn = null;
		try {
			conn = JDBCDataSource.getConnection();
	...
	public void update(StudentBean bean) throws ApplicationException,
		...
		try {
			...
			conn.setAutoCommit(false); // Begin transaction
			PreparedStatement pstmt = conn
					.prepareStatement("UPDATE demo_ors.student SET COLLEGE_ID=?,COLLEGE_NAME=?,FIRST_NAME=?,LAST_NAME=?,DATE_OF_BIRTH=?,MOBILE_NO=?,EMAIL=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=? WHERE ID=?");
	...
	public List search(StudentBean bean, int pageNo, int pageSize)
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM demo_ors.student WHERE 1=1");
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		...
		ArrayList list = new ArrayList();
		StringBuffer sql = new StringBuffer("select * from demo_ors.student");
